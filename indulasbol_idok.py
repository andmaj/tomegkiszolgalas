...
'''
indulasbol_idok.py - indulasi idobelyegekbol csinal abszolut ideju
(kezdeti idohoz kepest eltelt percek szama) es idodifferencia 
(indulasok kozott eltelt percek szama) fajlokat
